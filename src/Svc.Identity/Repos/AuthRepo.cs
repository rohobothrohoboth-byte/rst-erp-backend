...
public class AuthRepo<T> : IAuthRepo<T> where T : BaseEntity
{
    private readonly IDbConnection _dbConnection;
    private readonly ILogger<AuthRepo<T>> _logger;
    private readonly string _tableName;

    public AuthRepo(DapperContext context, ILogger<AuthRepo<T>> logger)
    {
