...
using Svc.Identity.Data;
using Svc.Identity.Models;
using Svc.Identity.Services;
...
internal static class HostingExtensions
{
    ...
    public static WebApplication ConfigureServices(this WebApplicationBuilder builder)
    {
        ...
        builder.Services.AddDbContext<ApplicationDbContext>(options => options.UseNpgsql(builder.Configuration.GetConnectionString("AuthDbCon")));
