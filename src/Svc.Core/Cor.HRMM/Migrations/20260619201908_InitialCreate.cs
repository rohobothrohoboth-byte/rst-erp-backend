        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Per = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsVacant = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SalaryPayFreq = table.Column<string>(type: "character varying(5)", maxLength: 5, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SaturdayWorkOption = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    SundayWorkOption = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
