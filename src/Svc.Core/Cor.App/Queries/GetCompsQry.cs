...
public class GetCompsQry : IRequest<List<CompListDto>> { }

public class GetCompsQryHandler : IRequestHandler<GetCompsQry, List<CompListDto>>
{
    private readonly IUnitOfWork _unitOfWork;

    public GetCompsQryHandler(IUnitOfWork unitOfWork) { _unitOfWork = unitOfWork; }

    public async Task<List<CompListDto>> Handle(GetCompsQry request, CancellationToken cancellationToken)
    {
