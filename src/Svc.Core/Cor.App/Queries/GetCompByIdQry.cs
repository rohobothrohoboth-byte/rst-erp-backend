...
public class GetCompByIdQry : IRequest<CompListDto?>
{
    public Guid Id { get; set; }
}

public class GetCompByIdQryHandler : IRequestHandler<GetCompByIdQry, CompListDto?>
{
    ...
    public async Task<CompListDto?> Handle(GetCompByIdQry request, CancellationToken cancellationToken)
    {
