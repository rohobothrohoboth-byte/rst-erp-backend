// E:\untitled46\RST_ERP\src\Svc.FileManagement\Cor.FileManagement\Handlers\GetFileQueryHandler.cs
...
public class GetFileQueryHandler : IRequestHandler<GetFileQuery, FileDocumentDto>
{
    private readonly FileDbContext _context;

    public GetFileQueryHandler(FileDbContext context)
    {
        _context = context;
    }

    public async Task<FileDocumentDto> Handle(GetFileQuery request, CancellationToken cancellationToken)
    {
