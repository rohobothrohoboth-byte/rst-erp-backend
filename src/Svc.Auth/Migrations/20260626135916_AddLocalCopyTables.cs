        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoleClaim_AppRole_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Branches_Companies_CompId",
                        column: x => x.CompId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PositionPerModule", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PositionPerModule_PerModule_PerModuleId",
                        column: x => x.PerModuleId,
                        principalTable: "PerModule",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PositionPerMenu", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PositionPerMenu_PerMenu_PerMenuId",
                        column: x => x.PerMenuId,
                        principalTable: "PerMenu",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PositionPerApi", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PositionPerApi_PerApi_PerApiId",
                        column: x => x.PerApiId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmploymentNature = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    WorkArrangement = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    EmpState = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    ...
                    PositionId = table.Column<Guid>(type: "uuid", nullable: false),
                    DepartmentId = table.Column<Guid>(type: "uuid", nullable: false),
                    AppUserId = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PerModule_Order",
                table: "PerModule",
                column: "Order");

            migrationBuilder.CreateIndex(
                name: "IX_PositionPerApi_PerApiId",
                table: "PositionPerApi",
                column: "PerApiId");

            migrationBuilder.CreateIndex(
                name: "IX_PositionPerApi_PositionId",
                table: "PositionPerApi",
                column: "PositionId");

            migrationBuilder.CreateIndex(
                name: "IX_PositionPerApi_Unique",
                table: "PositionPerApi",
                columns: new[] { "PositionId", "PerApiId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PositionPerMenu_PerMenuId",
                table: "PositionPerMenu",
                column: "PerMenuId");

            migrationBuilder.CreateIndex(
                name: "IX_PositionPerMenu_PositionId",
                table: "PositionPerMenu",
                column: "PositionId");

            migrationBuilder.CreateIndex(
                name: "IX_PositionPerMenu_Unique",
                table: "PositionPerMenu",
                columns: new[] { "PositionId", "PerMenuId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PositionPerModule_PerModuleId",
                table: "PositionPerModule",
                column: "PerModuleId");

            migrationBuilder.CreateIndex(
                name: "IX_PositionPerModule_PositionId",
                table: "PositionPerModule",
                column: "PositionId");

            migrationBuilder.CreateIndex(
                name: "IX_PositionPerModule_Unique",
                table: "PositionPerModule",
                columns: new[] { "PositionId", "PerModuleId" },
                unique: true);
