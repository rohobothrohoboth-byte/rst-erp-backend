...
public class EventConsumer : BackgroundService
{
 ...
 var factory = new ConnectionFactory
 {
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        _channel.BasicConsume("auth.sync.queue", autoAck: false, consumer);
    ...
    private async Task HandlePositionEvent(ISyncService syncService, string eventType, object data, CancellationToken ct)
    {
        ...
        var dto = new PositionDto
        {
            ...
            IsVacant = positionData.IsVacant,
        ...
        switch (eventType)
        {
            case "CREATED":
            case "UPDATED":
                await syncService.SyncPositionAsync(dto, ct);
    ...
    private async Task HandleJobGradeEvent(ISyncService syncService, string eventType, object data, CancellationToken ct)
    {
        ...
        switch (eventType)
        {
            case "CREATED":
            case "UPDATED":
                await syncService.SyncJobGradeAsync(dto, ct);
