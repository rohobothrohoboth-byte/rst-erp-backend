...
public class AuditLogEventDto
{
    ...
    public string? MetadataJson { get; set; }  // Add this
    ...
    public Guid? CreatedByUserId { get; set; }  // Add this
    public string? CreatedByUserName { get; set; }  // Add this
    public Guid? PeriodId { get; set; }  // Add this
    public Guid? UpdatedByUserId { get; set; }  // Add this
    public string? UpdatedByUserName { get; set; }  // Add this
}
