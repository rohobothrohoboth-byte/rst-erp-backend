...
public class PositionReqDto
{
    ...
    public Guid PositionId { get; set; }
    public string Gender { get; set; } = string.Empty;
    public string SaturdayWorkOption { get; set; } = string.Empty;
    public string SundayWorkOption { get; set; } = string.Empty;
    public string ProfessionType { get; set; } = string.Empty;

    // ✅ WorkingHours as double (matches JSON number)
    ...
    public string SaturdayWorkOptionStr { get; set; } = string.Empty;
    public string SundayWorkOptionStr { get; set; } = string.Empty;
    public string ProfessionTypeStr { get; set; } = string.Empty;
    public string RowVersion { get; set; } = string.Empty;
    public string CreatedAt { get; set; } = string.Empty;
    public string CreatedAtAm { get; set; } = string.Empty;
    public string ModifiedAt { get; set; } = string.Empty;
    public string ModifiedAtAm { get; set; } = string.Empty;
}
