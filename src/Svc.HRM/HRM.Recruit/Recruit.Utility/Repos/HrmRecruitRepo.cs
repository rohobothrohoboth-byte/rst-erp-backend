...
public class HrmRecruitRepo<T> : IHrmRecruitRepo<T> where T : BaseEntity
{
    private readonly IDbConnection _dbConnection;
    private readonly ILogger<HrmRecruitRepo<T>> _logger;
    private readonly string _tableName;

    public HrmRecruitRepo(DapperContext context, ILogger<HrmRecruitRepo<T>> logger)
    {
