...
namespace Svc.HRM.Payroll.Migrations
{
    ...
    [Migration("20260808211837_AddFinancePostingFields")]
    partial class AddFinancePostingFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Svc.HRM.Payroll.Models.Entities.LocalPayrollRun", b =>
                {
                    ...
                    b.Property<DateTime?>("FinancePostedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("FinancePostingError")
                        .HasColumnType("text");
